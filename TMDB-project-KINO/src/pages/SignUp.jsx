        ...
        <div className='w-full h-auto items-center justify-center flex bg-white'>
            <div className={` ${isMobile ? "w-5/6" : "w-2/6"}   h-auto flex flex-col mt-32 shadow-2xl border`}>
                ...
                <div className='flex items-start flex-col'>
                    <h1 className={` ${isMobile ? "text-2xl" : "text-4xl"}  text-clip pt-8 textblack opacity-90`}> Регистрация аккаунта </h1>
                </div>
                    <h1 className={` ${isMobile ? "" : "relative right-32"} pt-8`}> Введите свою почту* </h1>
                    <input 
                        value={email} 
                    ...
                    <h1 className={` ${isMobile ? "" : "relative right-32"} pt-8`}> Придумайте пароль* </h1>
                    ...
                    <h1 className={` ${isMobile ? "" : "relative right-32"} pt-8`}> Повторите пароль* </h1>
                    <div className='flex relative w-full items-center justify-center'>
                        <input 
                            value={copyPassword}   
                    ...
                    <div className='flex w-full'>
                        <Link className={` ${isMobile ? "pl-20" : "pl-28"} flex  pt-4 items-center`} to={'/sign-in'}> <h1> Уже есть аккаунт? </h1> <span className='text-blue-500 pl-1'> Войти </span> </Link>
                    </div>
                        <button 
